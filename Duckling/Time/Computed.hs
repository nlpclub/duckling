...
module Duckling.Time.Computed
  ( chanukah, chineseNewYear, chineseNewYearEve, jingZhe, dragonBoat
  , midAutumn, doubleNinth, dhanteras, easterSunday, eidalAdha, eidalFitr
  , globalYouthServiceDay, guruGobindSinghJayanti, karvaChauth, ghost
...
chineseNewYearEve :: TimeData
chineseNewYearEve = computedDays chineseNewYearEve'

chineseNewYearEve' :: [TimeObject]
chineseNewYearEve' = mapMaybe toTimeObjectM
  [(1901, 2, 18),
 (1902, 2, 7),
 (1903, 1, 28),
 (1904, 2, 15),
...
doubleNinth :: TimeData
doubleNinth = computedDays doubleNinth'

doubleNinth' :: [TimeObject]
doubleNinth' = mapMaybe toTimeObjectM
  [(1901, 10, 20),
 (1902, 10, 10),
 (1903, 10, 28),
 (1904, 10, 17),
...
ghost :: TimeData
ghost = computedDays ghost'

ghost' :: [TimeObject]
ghost' = mapMaybe toTimeObjectM
  [(1901, 8, 28),
 (1902, 8, 18),
 (1903, 9, 6),
 (1904, 8, 25),
...
midAutumn :: TimeData
midAutumn = computedDays midAutumn'

midAutumn' :: [TimeObject]
midAutumn' = mapMaybe toTimeObjectM
  [(1901, 9, 27),
 (1902, 9, 16),
 (1903, 10, 5),
 (1904, 9, 24),
...
dragonBoat :: TimeData
dragonBoat = computedDays dragonBoat'

dragonBoat' :: [TimeObject]
dragonBoat' = mapMaybe toTimeObjectM
  [(1901, 6, 20),
 (1902, 6, 10),
 (1903, 5, 31),
 (1904, 6, 18),
